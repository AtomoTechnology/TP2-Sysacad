...
namespace UI.Vista
{
    public class Usuarios
    {
        ...
        private Business.Logic.EspecialidadLogic el;
        ...
        public void Menu()
        {
            ...
            do
            {
                ...
                Console.WriteLine("-----------------------------------------------------");
                Console.WriteLine("7- Listar Especialidades");
                ...
                switch (opcion)
                {
                    ...
                    case "5":
                        ...
                        break;
                    case "7":
                        this.ListarEspecialidades(  el.GetAll());
                        break;
                    default:
                        break;
                }
        ...
        public void ListarEspecialidades( List<Especialidad> lel)
        {
            if(lel.Count() > 0)
            {
                ...
                {
                    Console.WriteLine("DescripcionEsp : {0} ", l.desc_especialidad);
                }
            }
            else
            {
                Console.WriteLine("No hay especialidades por el momento!!!");
            }
        }
